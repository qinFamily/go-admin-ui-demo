    ...
    >
      ...
      >
        ...
        <el-form-item label="隐藏" prop="is_hidden">
          <el-switch v-model="temp.is_hidden" active-color="#13ce66" inactive-color="#ff4949" />
        </el-form-item>
        ...
        <el-form-item label="允许撤回" prop="enable_retreat">
          <el-switch v-model="temp.enable_retreat" active-color="#13ce66" inactive-color="#ff4949" />
