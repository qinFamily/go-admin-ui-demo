<template>
  <div class="app-container">
    <div class="ticket">
      ...
      <div v-if="customfield_list.length>0" class="ticket-form">
        <el-form ref="temp" :rules="rules" :model="temp" label-width="100px">
          <el-card>
            <div slot="header" class="card-solt">
              <el-form-item label="工单标题">
                <el-input v-model="this.wfdata.name" disabled />
              </el-form-item>
            </div>
            <el-row :gutter="20">
              <el-col
            ...
            <el-form-item v-if="stateActive<999" label="审批意见">
              <el-input
                v-model="wfdata.memo"
                type="textarea"
                :autosize="{ minRows: 4, maxRows: 6}"
            ...
            <el-form-item>
              <span v-for="item in transition_list" :key="item.id" style="margin: 0 5px;">
                <el-button
                  v-if="item.name===1"
    ...
    <el-dialog :visible.sync="dialogVisible">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="16">
          <el-table :data="choice_user_list" style="width: 100%" @row-click="checkTableUser">
      ...
      <el-row>
        <el-input v-model="wfdata.participant" readonly>
